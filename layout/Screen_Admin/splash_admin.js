...
const Splash = ({navigation}) => {
    ...
    return (
        <View style={{flex:1,flexDirection:'column',justifyContent:'center',alignItems:'center',backgroundColor:'#fff'}} >
            ...
            <Image source={require('../images/logo.png')} style={{width:300,height:300}}  />    
            <Text style={{fontFamily:'OpenSans-Bold',fontSize:40,color:'#000'}} >UIT Borrow - Admin Version</Text>
        </View>
    )
};
